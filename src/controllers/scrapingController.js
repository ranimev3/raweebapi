...
export const getManhwaDetail = async (req, res) => {
  ...
  try {
    ...
    const updatedOn = $(".info-left .tsinfo .imptdt").eq(4).text().trim().replace('Posted On ', '');
...
//komikstation
export const getHomev2 = async (req, res) => {
  try {
...
export const getManhwaPopularv2 = async (req, res) => {
  try {
    const url = "https://komikstation.org/manga/?type=manhwa&order=popular";
...
export const getManhwaRecommendationv2 = async (req, res) => {
  try {
    const urls = [
      "https://komikstation.org/manga/?page=2&type=manga&order=popular",
...
export const getManhwaNewv2 = async (req, res) => {
  try {
    const url = "https://komikstation.org/";
    const html = await fetchPage(url);
    const $ = load(html);
...
export const getManhwaTopv2 = async (req, res) => {
  const url = "https://komikstation.org/";
...
export const getGenresv2 = async (req, res) => {
  try {
...
export const getGenreIdv2 = async (req, res) => {
  const { genreId } = req.params;
...
export const getGenreIdPagev2 = async (req, res) => {
  const { genreId, pageNumber } = req.params;
  const url = `https://komikstation.org/genres/${genreId}/page/${pageNumber}`;
...
export const getSearchv2 = async (req, res) => {
  const { searchId } = req.params;
...
export const getSearchPagev2 = async (req, res) => {
  const { searchId, pageNumber } = req.params;
...
export const getManhwaOnGoingv2 = async (req, res) => {
  const url =
